...
def move_and_measure(
    motors: dict, tagger: object, s_state: str, i_state: str, settings: dict[str, tuple[float, float]], wait_time: float
) -> int:
...
def calculate_visibility(coincidence_counts: dict[tuple[str, str], int], pairs: list[tuple[str, str]]) -> float:
