...
def expectation_value(
    ...
    angles1 = [[idler_hwp_angle, idler_qwp_angle], [idler_hwp_angle + 45, idler_qwp_angle]]
    angles2 = [[signal_hwp_angle, signal_qwp_angle], [signal_hwp_angle + 45, signal_qwp_angle]]
    coincidence_counts = []
    for angle1 in angles1:
        for angle2 in angles2:
            ...
            sleep(2)
            counts = timetagger.measure_coincidence(
                channel1, channel2, int(binwidth * 1e12), int(measurement_duration * 1e12)
            )
